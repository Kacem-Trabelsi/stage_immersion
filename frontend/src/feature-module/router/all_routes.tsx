export const all_routes = {
  ...
  s2tIndicators: "/startup/s2t-indicators",
  ...
  meetingsPlanner: "/application/meetings-planner",
  meetingRoom: "/application/meeting-room",
  ...
  expertProfile: "/experts/profile/:expertId",
