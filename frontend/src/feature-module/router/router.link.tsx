...
import ExpertsList from "../crm/experts/expertsList";
import ExpertProfile from "../crm/experts/expertProfile";
...
import S2TIndicatorsPage from "../pages/s2t-indicators";
...
export const publicRoutes = [
  ...
  {
    path: routes.s2tIndicators,
    element: <S2TIndicatorsPage />,
    route: Route,
  },
  {
