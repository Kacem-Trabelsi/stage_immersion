...
import StartupProfileForm from "../../pages/profile/StartupProfileForm";
                    ...
                    <div className="content">
                        ...
                        <div className="d-md-flex d-block align-items-center justify-content-between page-breadcrumb mb-3">
                            <div className="my-auto mb-2">
                                <h2 className="mb-1">{isStartupSession ? "Startup Settings" : "Settings"}</h2>
                                <nav>
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <div className="alert alert-info">
                                        Configure your startup business profile and branding from this section.
                                    </div>
                                    <StartupProfileForm />
                                </div>
                            </div>
